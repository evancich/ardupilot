...
#define HAL_BOARD_IMX6S    9  //HOU for iMX6SL
...
/**
   HAL IMX6S sub-types, starting at 9000
 */
#define HAL_BOARD_SUBTYPE_IMX6S_V10      9000 //HOU
...
#elif CONFIG_HAL_BOARD == HAL_BOARD_IMX6S  //HOU
	#define AP_HAL_BOARD_DRIVER AP_HAL_IMX6S

	#define HAL_BOARD_NAME "IMX6S"
	#define HAL_CPU_CLASS HAL_CPU_CLASS_1000
	#define HAL_OS_POSIX_IO 0
	#define HAL_BOARD_LOG_DIRECTORY "/fs/microsd/APM/LOGS"
	#define HAL_BOARD_TERRAIN_DIRECTORY "/fs/microsd/APM/TERRAIN"
	#define HAL_INS_DEFAULT HAL_INS_IMX6S
	#define HAL_BARO_DEFAULT HAL_BARO_IMX6S
	#define HAL_COMPASS_DEFAULT HAL_COMPASS_IMX6S
	#define HAL_SERIAL0_BAUD_DEFAULT 115200

	#if  defined(CONFIG_ARCH_BOARD_IMX6S_V10)
		#define CONFIG_HAL_BOARD_SUBTYPE HAL_BOARD_SUBTYPE_IMX6S_V10
		#define HAL_STORAGE_SIZE            8192
	#else
		#define CONFIG_HAL_BOARD_SUBTYPE HAL_BOARD_SUBTYPE_NONE
		#define HAL_STORAGE_SIZE            8192
