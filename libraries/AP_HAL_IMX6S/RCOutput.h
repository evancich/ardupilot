...
#ifndef __AP_HAL_IMX6S_RCOUTPUT_H__
#define __AP_HAL_IMX6S_RCOUTPUT_H__
...
#define IMX6S_NUM_OUTPUT_CHANNELS 16

class IMX6S::IMX6SRCOutput : public AP_HAL::RCOutput
{
public:
...
private:
    ...
    int _alt_fd;
    uint16_t _freq_hz;
    uint16_t _period[IMX6S_NUM_OUTPUT_CHANNELS];
...
#endif // __AP_HAL_IMX6S_RCOUTPUT_H__
